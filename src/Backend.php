...
class Backend
{
  ...
  {
    print '<div class="error"><p>Sorry, but this theme requires the ACF plugin to be installed and active, you might encourage strange behaviour until you install and activate ACF</p></div>';
  }
